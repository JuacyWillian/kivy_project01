...
from config import DEFAULT_ICON_FONT_NAME
...
def register_iconfont(name, ttf_fname, fontd_fname, **kwargs):
...
def icon(code, size=None, color=None, font_name=DEFAULT_ICON_FONT_NAME):
...
def create_fontdict_file(css_fname, output_fname, **kwargs):
